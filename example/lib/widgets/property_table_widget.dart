    ...
    return SingleChildScrollView(
      ...
      child: DataTable(
        ...
        rows: <DataRow>[
          ...
          DataRow(cells: [
            DataCell(Text('upperCurveWidthTxtCtrl',style: heading2Style,textAlign: TextAlign.center)),
            DataCell(Text('upperCurveWidthTxtCtrl',style: heading2Style,textAlign: TextAlign.center)),
          ...
          DataRow(cells: [
            DataCell(Text('upperStrokeCurveWidthTxtCtrl',style: heading2Style,textAlign: TextAlign.center)),
            DataCell(Text('upperStrokeCurveWidthTxtCtrl',style: heading2Style,textAlign: TextAlign.center)),
            DataCell(Text('0.16',style: heading2Style,textAlign: TextAlign.center)),
          ]),
          DataRow(cells: [
          ...
          DataRow(cells: [
            DataCell(Text('underCurveWidthTxtCtrl',style: heading2Style,textAlign: TextAlign.center)),
            DataCell(Text('underCurveWidthTxtCtrl',style: heading2Style,textAlign: TextAlign.center)),
          ...
          DataRow(cells: [
            DataCell(Text('underStrokeCurveWidthTxtCtrl',style: heading2Style,textAlign: TextAlign.center)),
            DataCell(Text('underStrokeCurveWidthTxtCtrl',style: heading2Style,textAlign: TextAlign.center)),
            DataCell(Text('0.18',style: heading2Style,textAlign: TextAlign.center)),
          ]),
          DataRow(cells: [
